...
class _PainelMotoristaState extends State<PainelMotorista> {
  ...
  void initState() {
    ...
    super.initState();
    //adiciona listener para recuperar requisicoes
    //_adicionarListenerRequisicoes();

    /*recupera requisicao ativa para verificar se o motorista está
    * atendendo aluma requisicao e envia ele para tela de corrida*/
  ...
  Widget build(BuildContext context) {
    ...
    var mensagemNaoTemDados = Center(
      child:Text("Não possui Requisições", style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
    );
